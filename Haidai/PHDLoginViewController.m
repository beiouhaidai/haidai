...
#import "PHDNewUserViewController.h"

@interface PHDLoginViewController ()
<UITextFieldDelegate,
UIScrollViewDelegate,
PHDNewUserViewControllerDelegate>
...
@implementation PHDLoginViewController
...
- (void)presentNewUserViewController {
    PHDNewUserViewController *viewController = [[PHDNewUserViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)setActivityViewVisible:(BOOL)visible {
    ...
    if (_activityViewVisible) {
        PHDActivityView *activityView = [[PHDActivityView alloc] initWithFrame:self.view.bounds];
