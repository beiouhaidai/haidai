...
@interface PHDNewUserViewController () <UITextFieldDelegate, UIScrollViewDelegate>
...
@implementation PHDNewUserViewController
...
- (void)processFieldEntries {
    ...
    PHDActivityView *activityView = [[PHDActivityView alloc] initWithFrame:CGRectMake(0.f, 0.f, self.view.frame.size.width, self.view.frame.size.height)];
